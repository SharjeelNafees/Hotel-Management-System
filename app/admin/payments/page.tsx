...
export const metadata = { title: 'Payments | Admin | Hotel Nova' }
    ...
    <main className="min-h-screen pt-24 px-6 bg-gradient-to-br from-slate-50 via-white to-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="mb-8 flex items-start justify-between">
          <div>
            <h1 className="font-serif text-3xl md:text-4xl font-bold text-gray-900">Payments</h1>
            <p className="mt-1 text-sm text-gray-600">Track invoices and transactions. (Coming soon)</p>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-100">
          <p className="text-gray-600">This module will allow you to manage payments, refunds, and invoices. Placeholder for now.</p>
        </div>
      </div>
    </main>
  )
